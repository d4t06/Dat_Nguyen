...
export default function Frame({ children, className = '' }: { children: ReactNode, className?: string }) {
    return (
        <div className="shadow-[0_1rem_2rem_rgba(0,0,0,0.4)] rounded-xl overflow-hidden">
            <div className="flex px-4 justify-end py-3 space-x-2 bg-gray-600">
            ...
            <div
                ...
                className={`p-4 text-base bg-gray-900 md:p-6 font-[monospace] ${className}`}
            >
                {children}
            </div>
        </div>
